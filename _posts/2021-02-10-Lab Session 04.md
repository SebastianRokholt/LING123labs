...
If you only complete Part 1 and 2, that's fine for now. It is OK to wait with Part 3, and instead do those
exercises as exam preparations.

The lecture notes for lecture 4 can be found
[here](https://lingkurs.h.uib.no/webroot/index.php?page=scripting/countcolumns&lang=en&course=ling123).
<br>
