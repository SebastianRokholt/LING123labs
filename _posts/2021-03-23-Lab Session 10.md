...
Then we're going to work on XML processing! <br>


This will probably be the last lab, but I'll be available on email and MittUiB if you have further questions
regarding the programming curriculum for LING123. I will make sure to post my solutions for all lab exercises well in
advance of the exam. If you get stuck on the final obligatory assignment or the home exam,
I advise you to take a look at the solutions for the lab exercises.
They might give you some insight or inspiration on how to solve them! <br>
...
## Part 2: Introduction to XML processing


### Exercise 2.1: Filtering XML with XSLT
Look at the examples in the [lecture notes](https://lingkurs.h.uib.no/webroot/index.php?page=xml/xsl-filtering&lang=en&course=ling123).
...
### Exercise 2.2: Filtering XML with XSLT
